...
/*Do not call denmos or lvgl drawing after lv_timer_handler*/
#if 0 //simple test case: display lvgl version
   ...
   */
    ...
    */
    ...
    xTaskCreatePinnedToCore(lv_timer_handler_task, "lv_timer_handler_task", 1024 * 8, NULL, 5, NULL, 0);
}